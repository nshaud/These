...
\chapter{Spatialisation des prédictions pixelliques}
...
\begin{figure}
  \foreach\picname\picpath in {Image \glsname{RVB} et segmentation/vehicles.jpg,Masque des véhicules/mask.jpg,Masque après ouverture/opening.jpg,Composantes connexes/components.png}{%
...
\begin{figure}[t]
    ...
    \mycaption{Exemples de segmentations obtenues sur Potsdam et Christchurch.}{\\\isprslegende}
...
\begin{table}[t]
\centering
	\mycaption{Résultats de segmentation sémantique sur le jeu de données \glsname{ISPRS} Potsdam à \SI{12,5}{\centi\meter/\px}}{(scores $F_1$ et exactitude globale).}
    ...
    \midrule
    \multirow{2}{*}{Test \SI{5}{\centi\meter/\px}} & SegNet \glssymbol{IRRV} & \res{92.4}{} & \res{95.8}{} & \res{86.7}{} & \res{87.4}{} & \res{95.1}{} & \res{90.0}{}\\
     & \glsname{FCN} + \glsname{CRF}~\cite{sherrah_fully_2016} & \res{91.8}{} & \res{95.9}{} & \res{86.3}{} & \res{87.7}{} & \res{89.2}{} & \res{89.7}{}\\
     \bottomrule
  \end{tabularx}}
\end{table}
...
\begin{table}[t]
\centering
	\mycaption{Résultats de segmentation sémantique sur NZAM/ONERA Christchurch}{(scores $F_1$ et exactitude globale).}
...
\centering
	...
	\mycaption{Exemples de détections sur Potsdam et Christchurch}{(vrais positifs en vert, faux positifs en rouge et vérité terrain en bleu).}
...
\begin{table}[t]
\centering
  \mycaption{Segmentation d'instance et détection de véhicules pour différents prétraitements morphologiques}{(\glssymbol{IsU} moyen, précision et rappel).}
  ...
  \multirow{3}{*}{\shortstack{NZAM/ONERA\\ Christchurch}} & $\emptyset$ &  \num{60.0}\% & \num{0.597} & \num{0.797}\\
  & Ouverture & \num{69.8}\% & \num{0.817} & \num{0.791}\\
  & Ouverture + retrait des petits objets & \num{70.7}\% & \num{0.833} & \num{0.791}\\
  \midrule
  \multirow{3}{*}{ISPRS Potsdam} & $\emptyset$ & \num{70.1}\% & \num{0.748} & \num{0.842}\\
  & Ouverture & \num{73.3}\% & \num{0.866} & \num{0.842}\\
  & Ouverture + retrait des petits objets & \num{74.2}\% & \num{0.907} & \num{0.841}\\
  \bottomrule
  \end{tabularx}
...
\begin{table}[t]
\centering
	\mycaption{Résultats de classification de plusieurs \glssymbol{CNN} sur \glsname{VEDAI} (en \%).}{\small OA = \emph{Overall Accuracy} (exactitude globale).}
...
\begin{table}[t]
\centering
	\mycaption{Résultats de classification d'AlexNet sur \glsname{VEDAI} avec plusieurs prétraitements (en \%).}{\small OA = \emph{Overall Accuracy} (exactitude globale), AA = \emph{Average Accuracy} (exactitude moyenne).}
    \label{table:da_benchmark}
    \setlength\tabcolsep{3pt}
   \scalebox{0.78}[0.78]{
	\begin{tabularx}{1.3\textwidth}{YYYYYYYYYYYY}
    \toprule
    \textbf{prétraitement} &  \textbf{Voiture} & \textbf{Camion} & \textbf{Bateau} & \textbf{Tracteur} & \textbf{Camping-car} & \textbf{Van} & \textbf{Pick-up} & \textbf{Avion} & \textbf{Autres} & \textbf{OA} & \textbf{AA}\\
    \midrule
    ...
    $\emptyset$ & \res{90.4}{} & \res{66.7}{} & \res{80.4}{} & \bres{89.5}{} & \res{96.6}{} & \res{63.3}{} & \res{78.7}{} & \res{92.6}{} & \res{75.0}{} & \res{83.9}{} \tiny $\pm$ 2.7 & \res{81.5}{1.9}\\
    AD & \res{88.2}{} & \res{82.2}{} & \res{78.4}{} & \res{82.5}{} & \bres{97.4}{} & \res{63.3}{} & \res{85.1}{} & \res{66.7}{} & \res{73.3}{} & \res{85.6}{1.4} & \res{77.3}{8.7}\\
    R & \res{87.9}{} & \res{71.1}{} & \res{86.3}{} & \res{84.2}{} & \bres{97.4}{} & \res{73.3}{} & \bres{87.2}{} & \bres{100.0}{} & \res{75.0}{} & \res{86.1}{0.9} & \res{84.7}{1.7}\\
    AD + R & \bres{91.4}{} & \bres{85.6}{} & \bres{88.2}{} & \res{87.6}{} & \bres{97.4}{} & \bres{70.0}{} & \bres{87.2}{} & \bres{100.0}{} & \bres{81.7}{} & \bres{89.0}{0.5} & \bres{87.7}{1.5}\\
    \bottomrule
  \end{tabularx}}
    \begin{tabular}{ccc}
...
\begin{table}[t]
\centering
  \mycaption{Résultats de classification de véhicules sur les vérités terrain augmentées de Potsdam et Christchurch.}{\small OA = \emph{Overall Accuracy} (exactitude globale), AA = \emph{Average Accuracy} (exactitude moyenne).}
...
\begin{figure*}[!t]
	\centering
	\resizebox{\textwidth}{!}{\input{Chapitre6/multitask_distances.tikz}}
    \mycaption{Apprentissage multitâche (classification pixel à pixel et régression des cartes de distances).}{Les couches convolutives sont en {\color{blue}bleu}, les activations non-linéaires en {\color{green!50!black}vert} et les cartes d'activation en {\color{brown}marron}.}
...
\begin{table}[h]
  \setlength\tabcolsep{2pt}
  \mycaption{Résultats de validation croisée sur les jeux de données ISPRS (multitâche).}{Les valeurs indiquées représentent le taux global de bonne classification et le score $F_1$ pour chaque classe.}
...
SegNet* (régression) & \multirow{3}{*}{Vaihingen} & \res{89.49}{} & \res{91.03}{} & \res{95.60}{} & \res{81.23}{} & \res{88.31}{} & \res{0.00}{}\\
% Classif (lambda = 0) : OA : 90.00 +- 1.17 F1 : 91.98 +- 1.62 F1 : 95.53 +- 0.20 F1 : 80.91 +- 2.62 F1 : 88.07 +- 2.33 F1 : 87.94 +- 1.76
SegNet* (classification) & & \res{90.00}{} & \res{91.98}{} & \res{95.53}{} & \res{80.91}{} & \res{88.07}{} & \res{87.94}{}\\
% multitask (lambda = 2) : OA : 90.43 +- 1.00 F1 : 92.46 +- 1.41 F1 : 95.99 +- 0.24 F1 : 81.30 +- 2.96 F1 : 88.34 +- 2.09 F1 : 88.16 +- 1.24
SegNet* (multitâche) & & \bres{90.43}{} & \bres{92.46}{} & \bres{95.99}{} & \bres{81.30}{} & \bres{88.34}{} & \bres{88.16}{}\\
\midrule
...
SegNet* (classification) & \multirow{2}{*}{Potsdam} & \res{91.85}{} & \res{94.12}{} & \res{96.09}{} & \res{88.48}{} & \res{85.44}{} & \res{96.62}{}\\
% multitask (lambda = 2) : OA : 92.22 +- 1.15 F1 : 94.33 +- 0.45 F1 : 96.52 +- 1.03 F1 : 88.55 +- 0.62 F1 : 86.55 +- 1.28 F1 : 96.79 +- 0.37
SegNet* (multitâche) & & \bres{92.22}{} & \bres{94.33}{} & \bres{96.52}{} & \bres{88.55}{} & \bres{86.55}{} & \bres{96.79}{}\\
\bottomrule
\end{tabularx}
\end{table}
...
%SegNet is trained for 50 epochs with a batch size of 10. Optimization is done using Stochastic Gradient Descent (SGD) with a base learning rate of 0.01, divided by 10 after 25 and 45 epochs, and a weight decay set at 0.0005. Encoder weights are initialized from VGG-16~\cite{simonyan_very_2015} trained on ImageNet~\cite{deng_imagenet:_2009}, while decoder weights are initialized using the policy from~\cite{he_delving_2015}.
...
\mycaption{Extrait des résultats de segmentation sur le jeu de données \glsname{ISPRS} Vaihingen.}{\\\isprslegende}
...
\begin{figure}[ht]
  ...
  \end{subfigure}
\captionsetup{justification=justified,width=\textwidth}
\mycaption{Extrait des résultats de segmentation sur le jeu de données \glsname{ISPRS} Potsdam.}{\\\isprslegende}
...
\begin{figure*}[t]
  ...
  \end{subfigure}
\captionsetup{justification=justified,width=\textwidth}
\mycaption{Extrait des résultats de segmentation sur le jeu de données INRIA \emph{Aerial Image Labeling}.}{Les pixels corrects sont en \textcolor{OliveGreen}{vert}, les faux positifs en \textcolor{Lavender}{rose} et les faux négatifs en \textcolor{Blue}{bleu}. L'approche multitâche capture mieux la structure spatiale des objets.}
...
\toprule
Méthode & Exactitude & \glssymbol{IsU} & Précision\\
\midrule
...
\begin{table}[ht]
  \mycaption{Résultats de segmentation sémantique sur le jeu de données \glsname{DFC} 2015}{(scores $F_1$ par classe et exactitude globale).}
...
\midrule
AlexNet (par \emph{patch})~\cite{campos-taberner_processing_2016} & \res{83.32}{} & \res{79.10}{} & \res{75.60}{} & \res{78.00}{} & \res{79.50}{} & \res{50.80}{} & \res{63.40}{} & \res{44.80}{} & \res{98.20}{}\\
SegNet (classification) & \res{86.67}{} & \bres{84.05}{} & \bres{82.21}{} & \res{82.24}{} & \res{69.10}{} & \res{79.27}{} & \res{65.78}{} & \bres{56.80}{} & \res{98.93}{}\\
SegNet (multitâche) & \bres{87.31}{} & \res{84.04}{} & \res{81.71}{} & \bres{83.88}{} & \bres{80.04}{} & \bres{80.27}{} & \bres{69.25}{} & \res{50.83}{} & \bres{98.94}{}\\
\bottomrule
\end{tabularx}
\end{table}
