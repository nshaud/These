...
\section{Modèles objet \emph{a posteriori}}
...
\subsubsection{\emph{Segment-before-detect}}
...
\centering
    ...
    \midrule
    Validation 12.5cm/px & SegNet RGB & \res{92.4}{0.6} & \res{95.8}{1.9} & \res{85.8}{1.3} & \res{83.0}{2.1} & \res{95.7}{0.3} & \res{90.6}{0.6}\\
	%\midrule
    \midrule
    \multirow{3}{*}{Test 5cm/px} & SegNet IRRG & 92.4\% & 95.8\% & \textbf{86.7\%} & 87.4\% & \textbf{95.1\%} & \textbf{90.0\%}\\
