...
\begin{figure}
  \foreach\picname\picpath in {Image \glsname{RVB} et segmentation/vehicles.jpg,Masque des véhicules/mask.jpg,Masque après ouverture/opening.jpg,Composantes connectées/components.png}{%
...
\centering
    ...
    \midrule
    \multirow{3}{*}{Test \SI{5}{\centi\meter/\px}} & SegNet \glssymbol{IRRV} & \res{92.4}{} & \res{95.8}{} & \res{86.7}{} & \res{87.4}{} & \res{95.1}{} & \res{90.0}{}\\
...
\begin{table}[t]
\centering
  \mycaption{Résultats de classification de véhicules sur les vérité terrain augmentées de Potsdam et Christchurch.}{\small OA = \emph{Overall Accuracy} (exactitude globale), AA = \emph{Average Accuracy} (exactitude moyenne).}
...
\publication{Les travaux de la~\cref{sec:segmentbeforedetect} ont été le sujet d'une publication journal:}{audebert_segment-before-detect_2017}
