...
\newcommand\convlayercontinued[3]{
   ...
   \coordinate (H) at (\x+\d/2,  \y+\h/2, \z-\w/2);
    ...
    \draw [draw opacity=0.3, fill opacity=0.8, fill=white!40!\col] (A) -- (B) -- (C) -- (D) -- cycle;
    \draw [draw opacity=0.3, fill opacity=0.8, fill=white!40!\col] (A) -- (B) -- (F) -- (E) -- cycle;
    % Face haut
    %\draw [left color=\col!60!white, right color=\col!80!white, shading=axis, shading angle=180] (C) -- (D)  -- (H) -- (G) -- cycle;
    \draw [fill opacity=0.9, fill=white!30!\col] (C) -- node[rotate=45,above] {\small \name} (D) -- (H) -- (G) -- cycle;
    %\draw [fill opacity=0.9, fill=\col!70!white] (C) -- (D) -- node[above] {\small \name} (H) -- (G) -- cycle;
    % Face droite
    \draw [fill opacity=0.9, fill=white!40!\col] (E) -- node[pos=0.75,rotate=45,below] {\scriptsize \notew} (F) -- (G) --  (H) -- cycle;
    % Face avant
    ...
    \draw [fill opacity=0.9, fill=white!50!\col] (B) -- node[above,rotate=90] {\scriptsize \noteh} (C) -- (G) -- (F) -- node[below] {\scriptsize \noted}  cycle;
}
...
\newcommand{\pixelddd}[7]{%{s}{w}{name}{color}{x}{y}{z}
		...
		\draw [draw opacity=0.2, fill opacity=0, densely dashed, fill=white!40!\col] (A) -- (B) -- (C) -- (D) -- cycle;
		\draw [draw opacity=0.2, fill opacity=0, densely dashed, fill=white!40!\col] (A) -- (B) -- (F) -- (E) -- cycle;
		\draw [draw opacity=0.2, fill opacity=0, densely dashed, fill=white!30!\col] (C) -- node[opacity=0.6,rotate=45,above] {\small \name} (D) -- (H) -- (G) -- cycle;
		\draw [draw opacity=0.2, fill opacity=0, densely dashed, fill=white!40!\col] (E) -- (F) -- (G) --  (H) -- cycle;
		\draw [draw opacity=0.7, fill opacity=0, fill=white!50!\col] (B) -- (C) -- (G) -- (F) -- node[below] {\scriptsize \noted}  cycle;
}
