...
L'approche GridNet~\cite{fourure_residual_2017} généralise plusieurs de ces topologies de réseaux pour la segmentation en proposant une architecture consistant en plusieurs ResNet parallèle dont les activations peuvent évoluer aussi en profondeur que latéralement.

Par ailleurs, \citet{peng_large_2017} ont proposé un module global de déconvolution pour mieux modéliser les relations spatiales à longue distance entre les éléments constitutifs d'une scène, combiné à une apprentissage résiduel pour raffiner les bordures des objets.
