...
Nous nous intéressons ensuite au cas particulier de l'imagerie hyperspectrale, pour laquelle le nombre élevé de longueurs d'onde d'acquisition nécessites des précautions supplémentaires. Nous explorons les architectures des réseaux l'état de l'art en apprentissage profond pour l'imagerie hyperspectrale et montrons qu'il existe un bénéfice significatif à déployer des modèles convolutifs à trois dimensions, en dépit du faible nombre d'exemples.
...
\begin{table}
  ...
  \caption{Comparaison des performances de segmentation de sémantique de SegNet sur le jeu de données de validation \glssymbol{ISPRS} Potsdam pour différentes combinaisons de canaux.}
