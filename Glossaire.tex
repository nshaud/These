...
\newacronym{DFC}{DFC}{\emph{Data Fusion Contest}}
...
\newglossaryentry{SVM}{
  ...
  description={\emph{Support Vector Machine}, en français Séparateur à Vaste Marge ou machines à vecteur de support. Outil de classification ou de régression.}
  }
...
\newacronym{SAR}{SAR}{radar à synthèse d'ouverture (en anglais \emph{synthetic aperture radar, SAR})}

\newacronym{CNES}{CNES}{Centre nationale d'études spatiales (CNES)}
...
\newacronym{CRF}{CRF}{\emph{Conditional Random Field} ou champ conditionel aléatoire (CRF)}
