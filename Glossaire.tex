...
\newglossaryentry{MNH}{
  ...
  description={Modèle Numérique de Hauteur. Mesure de la hauteur des points surélevés par normalisation par rapport au terrain sous-jacent}
}
...
\newglossaryentry{Pleiades}{
  name={Pléiades},
	...
	description={Paire de satellites optiques très haute résolution français}
}

\newglossaryentry{PyTorch}{
	name={PyTorch},
	first={PyTorch},
	description={Bibliothèque logicielle C++/Python de calcul tensoriel sur \gls{CPU} et \gls{GPU}, spécialisée pour l'apprentissage profond}
}
...
\newglossaryentry{SLIC}{
  ...
  description={\emph{Simple Linear Iterative Clustering}. Algorithme de segmentation superpixels}
}
...
\newglossaryentry{SEEDS}{
  ...
  description={\emph{Superpixels Extracted via Energy-Driven Sampling}. Algorithme de segmentation superpixels}
}
...
\newglossaryentry{ERS}{
	...
	description={Algorithme de segmentation par marche aléatoire}
}
...
\newglossaryentry{LSC}{
  ...
  description={\emph{Linear Spectral Clustering}. Algorithme de segmentation superpixels}
}
...
\newglossaryentry{MRS}{
  ...
  description={\emph{Multi-Resolution Segmentation}. Algorithme de segmentation multi-échelles implémenté dans le logiciel eCognition}
}
...
\newglossaryentry{FH}{
  ...
  description={Algorithme de segmentation d'image proposé par Felzenszwalb et Huttenlocher}
}
\newglossaryentry{IsU}{
  type=\acronymtype,
  name={IsU},
...
\newglossaryentry{SCALP}{
  ...
  description={\emph{Superpixels with Contour Adherence using Linear Path}. Algorithme de segmentation de type superpixels}
}
...
\newglossaryentry{HSEG}{
  ...
  description={\emph{Hierarchial Segmentation}. Algorithme de segmentation hiérarchique}
}
...
\newglossaryentry{HOG}{
  ...
  description={\emph{Histograms of Oriented Gradients} (HOG) ou histogrammes de gradients orientés. Approximation discrète de la distribution locale du gradient dans une image selon une direction pré-définie}
}
...
\newglossaryentry{SegNet}{
				name={SegNet},
				first={SegNet},
				description={Architecture de réseau de neurones entièrement convolutive pour la segmentation sémantique}
}
...
\newglossaryentry{FuseNet}{
				name={FuseNet},
				first={FuseNet},
				description={Architecture de réseau de neurones entièrement convolutive multi-modale, dérivée de \gls{SegNet}, pour la segmentation sémantique d'images \gls{RGB-D}}
}

\newglossaryentry{VGG-16}{
				name={VGG-16},
				first={VGG-16},
				description={Architecture de réseau de neurones convolutif à 16 couches pour la classification d'images}
}

\newglossaryentry{ResNet}{
				name={ResNet},
				first={ResNet},
				description={Architecture de réseau de neurones convolutif utilisant le paradigme d'apprentissage résiduel}
}

\newglossaryentry{AlexNet}{
				name={AlexNet},
				first={AlexNet},
				description={Architecture de réseau de neurones convolutif de classification d'images particulièrement populaire, arrivée en tête de la compétition \gls{ILSVRC} en 2012}
}
