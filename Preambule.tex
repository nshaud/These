...
\AtEveryBibitem{ % Ignore les "visité à ..."
    \clearfield{urlyear}
    \clearfield{urlmonth}
}
...
\usepackage{import}
\usepackage{mdframed}  % Boîtes colorées
\mdfdefinestyle{publi}{leftmargin=1cm,linecolor=mygreen,topline=false,rightline=false,bottomline=false,linewidth=4pt}
