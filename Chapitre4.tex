...
\chapsummary{%
Les chapitres précédent nous ont permis d'établir de nouveaux états de l'art en segmentation sémantique d'images de télédétection sur l'ensemble des capteurs optiques couramment mise en \oe{}uvre pour l'observation de la Terre. Cependant, nous avons également souligné la difficulté d'exploiter directement les modèles numériques de terrain dérivés du \gls{Lidar}.
...
Le module de correction résiduel étant optimisé pour la minimiser la fonction de coût, cette contrainte se traduit par\,:
\begin{equation}
