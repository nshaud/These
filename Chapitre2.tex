...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapsummary{%
	\lettrine{C}{e} chapitre présente deux méthodes pour la segmentation sémantique d'images aériennes très haute résolution : la classification par région et les réseaux entièrement convolutifs.
...
\begin{table}
  ...
  \bottomrule
  \end{tabularx}
  \caption{Métriques de comparaison des algorithmes de segmentation sur le jeu de données \glsname{ISPRS} Vaihingen.}
...
\begin{table}
  ...
  \bottomrule
  \end{tabularx}
  \caption{Résultats de segmentation sémantique sur le jeu de données \glsname{ISPRS} Vaihingen.}
...
\begin{table}[t]
  \centering
  \caption{Résultats du \glsname{ISPRS} 2D \emph{Semantic Labeling Challenge} Vaihingen.}
...
\begin{table}[t]
    \caption{Résultats du \glsname{ISPRS} 2D \emph{Semantic Labeling Challenge} Potsdam.}
